...
PropDialog::PropDialog(wxWindow* parent,wxWindowID id)
{
	...
	edName = new wxTextCtrl(this, ID_EDNAME, _("Text"), wxDefaultPosition, wxSize(321,-1), 0, wxDefaultValidator, _T("ID_EDNAME"));
	...
	edLogin = new wxTextCtrl(this, ID_EDLOGIN, _("Text"), wxDefaultPosition, wxSize(321,-1), 0, wxDefaultValidator, _T("ID_EDLOGIN"));
	...
	edEmail = new wxTextCtrl(this, ID_EDEMAIL, _("Text"), wxDefaultPosition, wxSize(321,-1), 0, wxDefaultValidator, _T("ID_EDEMAIL"));
	...
	edPass = new wxTextCtrl(this, ID_EDPASS, _("Text"), wxDefaultPosition, wxSize(321,-1), wxTE_PASSWORD, wxDefaultValidator, _T("ID_EDPASS"));
...
const int PropDialog::ShowModalEx(CRecord& rec, const ShowMode mode)
{
  ...
  if (mode == smVIEW)
  {
    ...
    RemoveChild(edPass);
    wxDELETE(edPass);
    edPass = new wxTextCtrl(this, ID_EDPASS, rec.password, wxDefaultPosition, wxSize(321,-1), 0, wxDefaultValidator, "ID_EDPASS");
