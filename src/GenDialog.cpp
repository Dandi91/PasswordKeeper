...
GenDialog::GenDialog(wxWindow* parent,wxWindowID id)
{
	...
	edPassword = new wxTextCtrl(this, ID_TEXTCTRL1, wxEmptyString, wxDefaultPosition, wxSize(272,-1), wxTE_PROCESS_ENTER|wxTE_PASSWORD, wxDefaultValidator, _T("ID_TEXTCTRL1"));
	...
	cbLower = new wxCheckBox(this, ID_CHECKBOX5, _("Lower case"), wxDefaultPosition, wxSize(88,-1), wxCHK_2STATE, wxDefaultValidator, _T("ID_CHECKBOX5"));
	cbLower->SetValue(true);
	StaticBoxSizer1->Add(cbLower, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cbUpper = new wxCheckBox(this, ID_CHECKBOX2, _("Upper case"), wxDefaultPosition, wxSize(85,-1), wxCHK_2STATE, wxDefaultValidator, _T("ID_CHECKBOX2"));
	cbUpper->SetValue(true);
	StaticBoxSizer1->Add(cbUpper, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cbDigits = new wxCheckBox(this, ID_CHECKBOX3, _("Digits"), wxDefaultPosition, wxSize(55,-1), wxCHK_2STATE, wxDefaultValidator, _T("ID_CHECKBOX3"));
	cbDigits->SetValue(true);
	StaticBoxSizer1->Add(cbDigits, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cbSpecials = new wxCheckBox(this, ID_CHECKBOX4, _("Special chars"), wxDefaultPosition, wxSize(95,-1), wxCHK_2STATE, wxDefaultValidator, _T("ID_CHECKBOX4"));
	...
	edMinLength = new wxTextCtrl(this, ID_TEXTCTRL2, _("10"), wxDefaultPosition, wxSize(45,-1), 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
	...
	edMaxLength = new wxTextCtrl(this, ID_TEXTCTRL3, _("20"), wxDefaultPosition, wxSize(45,-1), 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
...
void GenDialog::PasswordVisibility()
{
  ...
  delete edPassword;
  edPassword = new wxTextCtrl(this, ID_TEXTCTRL1, wxEmptyString, wxDefaultPosition, wxSize(272,-1), cbShow->GetValue() ? 0 : wxTE_PASSWORD, wxDefaultValidator, _T("ID_TEXTCTRL1"));
